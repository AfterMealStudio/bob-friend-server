...
request::
include::{snippets}/member/ban/http-request.adoc[]
path-param::
include::{snippets}/member/ban/request-headers.adoc[]
response::
include::{snippets}/member/ban/http-response.adoc[]
...
request::
include::{snippets}/member/ban/cancel/http-request.adoc[]
path-param::
include::{snippets}/member/ban/cancel/request-headers.adoc[]
response::
include::{snippets}/member/ban/cancel/http-response.adoc[]
